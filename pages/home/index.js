...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>Hoist Infotech - IT services</title>
        <link rel="shortcut icon" href="/assets/favicon.ico" />
        <meta name="description" content="Hoist Infotech works upon website development, mobile app development, android app development, IOS app development, etc." />
        <meta name="keywords" content="Hoist Infotech, Hoist technologies, IT solutions, IT agency, pvt. ltd., IT company in Pune, IT company in India, IT company in world, Best IT agency, Best IT company, Best IT venture, Web application, web apps, mobile apps, android app, IOS app, websites, PWA, IT QA" />
      ...
      <div>
        ...
        <Grid container className={styles.desc_container}>
          ...
          <Grid item xs={12} sm={6} className={styles.service_block}>
            <div className={styles.service_img_div}>
              <img src='/assets/mobileApp.png' width={'65%'} />
            </div>
          ...
          <Grid item xs={12} className={styles.service_block}>
            ...
            <span className={styles.embedded_service_text}>Embedded Design & Development</span>
          </Grid>
        </Grid>
